...
gErrDef =
{
	...
	---- pvp错误码 ---->
	Err_ROOM_EXIST = 600, --战场房间已存在
	Err_ROOM_NO_USER = 601, --玩家不在该战场
	Err_ROOM_HAD_LEAVE = 602, --玩家已离开战场 或战场已结算
	Err_ROOM_NOT_START_OR_END = 603, --战场未开始或已结算
	Err_ROOM_NOT_EXIST = 604, --战场房间不存在

	---- 地图/rpg错误码 ---->
	Err_ENTER_MAP = 700, --已进入地图
}

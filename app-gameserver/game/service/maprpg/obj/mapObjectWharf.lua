...
local mapObjectWharf = class("mapObjectWharf", mapObjectCell)

-- override
function mapObjectWharf.get_db_fields()
    local db_fields = mapObjectWharf.super.get_db_fields()
    table.merge(db_fields, {
        __table__ = "mapobjectwharf",
...
--初始化
function mapObjectWharf:init(params)

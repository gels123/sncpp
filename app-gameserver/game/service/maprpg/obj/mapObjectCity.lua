...
local mapObjectCity = class("mapObjectCity", mapObjectCell)

-- override
function mapObjectCity.get_db_fields()
    local db_fields = mapObjectCity.super.get_db_fields()
    table.merge(db_fields, {
        __table__ = "mapobjectcity",
...
--初始化
function mapObjectCity:init(params)

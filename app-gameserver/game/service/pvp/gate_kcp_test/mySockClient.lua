        ...
        elseif self.subid == 0 then --已请求握手
            ...
            while 1 do
                ...
                if hrlen > 0 then
                    ...
                    print("mySockClient:dispatch_msg response cmd=", self.session[sessionid] and self.session[sessionid].cmd, "rsp=", table2string(args))
...
--eg: reqCreatePvpBattle uid=101 batId=123 uids={101,102}
...
function mySockClient:request(cmd, args)
    print("mySockClient:request cmd=", cmd, "args=", table2string(args))
